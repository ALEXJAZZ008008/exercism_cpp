...
namespace say
{
    ...
    void tens(std::string& number_as_string, std::string& number_in_english)
    {
        ...
        {            
            ...
            switch(current_number)
            {
                ...
                case '1':
                {
                    if(number_in_english.size() > 0 and number_in_english.back() != ' ')
                    {
                        number_in_english += " ";
                    }
    ...
    {
        while(number_as_string.at(0) == '0')
        {
            if(number_as_string.size() < 4)
            {
                break;
            }
        ...
        size_t number_as_string_size = number_as_string.size();
